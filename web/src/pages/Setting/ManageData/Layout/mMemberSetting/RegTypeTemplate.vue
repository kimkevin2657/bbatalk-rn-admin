<template>
  <div>
    <q-table
      ...
      selection="multiple"
      separator="vertical"
      no-data-label="데이터를 찾지 못하였습니다. (신규, 재등록, 양도, 환불, 만기 등을 추가하세요.)"
    ...
    >
      ...
      <template #top>
        <div class="text-h6 col-12">등록 구분</div>
...
export default {
  ...
  data () {
    return {
      rowsSelected: [],
      columns: [
        { name: 'name', align: 'left', label: '등록 구분 명', field: 'name', sortable: true },
