<template>
  <div>
    <q-table
      :data="memberGroupDefineDataList"
      :columns="columns"
      ...
      selection="multiple"
      separator="vertical"
      no-data-label="데이터를 찾지 못하였습니다. (일반, 보증금, 입주민, 법인, 단체, 가족, 지원 등을 추가하세요.)"
    ...
    <member-group-popup ref="regPopup" />
  </div>
</template>
...
// Popup
import MemberGroupPopup from './popup/MemberGroupPopup'
import EditTemplate from '../../../../../components/template/EditTemplate'
// Mixin
import TableMixin from '../../../../../mixins/tableMixin'
export default {
  name: 'MemberGroupTemplate',
  components: {
    MemberGroupPopup,
    EditTemplate
  },
  ...
  data () {
    return {
      ...
      filter: '',
      columns: [
        { name: 'name', align: 'left', label: '회원 분류 명', field: 'name', sortable: true },
