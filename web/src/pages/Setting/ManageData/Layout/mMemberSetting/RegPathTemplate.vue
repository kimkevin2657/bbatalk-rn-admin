<template>
  <div>
    <q-table
      ...
      selection="multiple"
      separator="vertical"
      no-data-label="데이터를 찾지 못하였습니다. (지인 소개, 검색, SNS, 전단지, 카페, 블로그 등을 추가하세요.)"
...
export default {
  ...
  data () {
    return {
      ...
      filter: '',
      columns: [
        { name: 'name', align: 'left', label: '등록 경로 명', field: 'name', sortable: true },
